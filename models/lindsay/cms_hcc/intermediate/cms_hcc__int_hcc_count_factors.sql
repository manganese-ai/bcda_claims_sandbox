...
-- pull in seed data that gives coefficients for the total number of "payment HCCs" (4, 5, 6, 7, 8, 9, 10+ payment HCCs) and patient info (e.g., OREC, institutional status) for Continuing enrollees
...
-- count the number of HCC codes per patient
...
-- if the patient has >10 HCCs, recode to ">=10" HCCs
...
-- add coefficients for number of HCC codes to patient data
, hcc_counts as (
