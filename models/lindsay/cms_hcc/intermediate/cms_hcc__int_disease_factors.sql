...
-- pull in demographic info from cms_hcc__int_demographic_factors
...
-- pull in disease hierarchy info from cms_hcc__int_hcc_hierarchy
, hcc_hierarchy as (
...
-- get seed data that gives coefficients for combinations of HCC codes and patient info (e.g., OREC, institutional status) for Continuing enrollees
...
-- add disease-related coefficients to patient data
, disease_factors as (
