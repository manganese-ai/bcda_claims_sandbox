################################################################################################
# Tuva Script
# Copied from https://github.com/manganese-ai/FHIR_connector/blob/main/parseFhir.py
################################################################################################
...
####### Main #######
def parse_fihr(configpath, datapath):
    logging.info('Started parsing "%s"', configpath)
    config = configparser.ConfigParser()

    config.read(configpath)
    inputPath = os.path.join(datapath, config['GenConfig']['inputPath'])
    outputPath = os.path.join(datapath, config['GenConfig']['outputPath'])
