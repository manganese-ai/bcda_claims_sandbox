...
-- get seed data that gives coefficients for HCC codes for disabled, Continuing enrollees (e.g., Disabled & Congestive Heart Failure, HCC 85)
...
-- add disabled/HCC interaction coefficients to patient data
, interactions as (
