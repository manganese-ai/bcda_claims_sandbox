...
-- get data from cms_hcc__int_hcc_mapping
with hcc_mapping as (
...
-- get seed data regarding disease hierarchy (HCC codes and description)
...
-- select HCCs that do NOT have a hierarchy
...
-- select HCC codes that DO have a hierarchy to be evaluated (in the next cte)
